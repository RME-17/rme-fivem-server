...
Config = {}
Config.Debug = false
Config.Target = "ox_target"       -- RME: using ox_target (installed on this server) | "qb-target" | nil to disable targeting
...
Config.ImagesPath = "nui://qb-inventory/html/images/" -- RME: item images live in qb-inventory (the _icons folder isn't synced via GitHub)
...
Config.HuntingZones = {
    ["CHILIAD_MOUNTAINS"] = {
        ...
        allowedWeapons = { "WEAPON_HEAVYSNIPER_MK2", "WEAPON_HEAVYSNIPER", "WEAPON_SNIPERRIFLE", "WEAPON_DAGGER", "WEAPON_KNIFE" }, -- RME: broadened | nil to allow every weapon
        zone_radius = {
            enable = true,
            color = 1,
            opacity = 128,
        ...
        animals = {
            {
                ...
                harvestTime = 5,
                harvestWeapons = { "WEAPON_DAGGER", "WEAPON_KNIFE" }, -- RME: knife also works
                blip = {
                    enable = true,
                    name = 'Deer',
                    type = 119,
