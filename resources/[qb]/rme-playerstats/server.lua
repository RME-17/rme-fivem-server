...
--
-- NOTE: stats no longer decay based on real-world time away. Decay is handled
-- client-side and only happens while the player is actively in the city (see
-- rme-playerstats/client.lua + Config.Decay). Loading is a straight read.
