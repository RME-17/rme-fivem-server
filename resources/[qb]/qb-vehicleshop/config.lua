...
Config.Shops = {
    ['pdm'] = {
        ...
        ['VehicleSpawn'] = vector4(-55.41, -1114.0, 26.44, 34.01),   -- Spawn location when vehicle is bought (outside on the road)
        ['TestDriveSpawn'] = vector4(-55.41, -1114.0, 26.44, 34.01), -- Spawn location for test drive (outside on the road)
